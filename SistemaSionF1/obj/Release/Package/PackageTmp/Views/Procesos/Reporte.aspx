<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reporte.aspx.cs" Inherits="SistemaSionF1.Views.Procesos.Reporte" %>
              ...
              <a href="../Sesion/MenuBarra.aspx" class="active">Inicio</a>
               <div id="Procesos" runat="server" class="dropdown">
                ...
                <div class="dropdown-content">
                  ...
                  <a id="Reporte2" runat="server" href="Reporte.aspx">Reporte Documentos</a>
            ...
            <div class="formularioCobros">
                <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                 ...
                 <div style="display:flex; justify-content:center">
                    <label style="font-size:18px" class="titulos"><b>Reporte de documentos</b></label>
                 </div><br />
