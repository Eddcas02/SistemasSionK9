<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="controlExpedientes.aspx.cs" Inherits="SistemaSionF1.Views.MantenimientosControl.controlExpedientes" %>
...
<body>
    ...
    <form id="form1" runat="server">
          ...
          <h1 style="color:white">Mantenimiento Sistema Expedientes</h1>
  <div class="inset" >
<div class="row" id="mantuser" runat="server">
    <p class="col-md-6">
        ...
        <input style="color:black" type="text" name="email" id="NOMCOM" disabled="disabled" runat="server">
        <label  style="color:white">CIF</label>
        <input style="color:black" class="form-control form-control-lg"  name="email" id="CIF" runat="server" maxlength="10" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="number" min="0" required>
    ...
    <p class="col-md-6">
        ...
        <label  style="color:white">Rol</label>
         ...
         <asp:DropDownList ID="DDROL" runat="server" CssClass="dis" AutoPostBack="false"></asp:DropDownList>
           ...
           <label  style="color:white">Permiso</label>
        <input style="color:black" type="text" name="email" id="TXTPERMISO"  runat="server">
    </p>
