<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ControlProcesos.aspx.cs" Inherits="SistemaSionF1.Views.MantenimientosControl.ControlProcesos" %>
...
<body>
    ...
    <form id="form1" runat="server">
         <h1 style="color:white">Estado Usuarios Procesos</h1>
          <div class="inset">
    <div class="row">
        ...
        <div class="row">
            <label  style="color:white">Seleccione Categoria</label>
            <asp:DropDownList ID="Categoria" runat="server" CssClass="dis3" AutoPostBack="false"></asp:DropDownList>
        </div>

        <div class="row">
            <label  style="color:white">Seleccione Subcategoria</label>
            <asp:DropDownList ID="Subcategoria" runat="server" CssClass="dis3" AutoPostBack="false"></asp:DropDownList>
        </div>

        <div class="row">
            <label style="color:white">Seleccione tipo de usuario</label>
             <asp:DropDownList ID="TipoUsuario" runat="server" CssClass="dis3" AutoPostBack="false"></asp:DropDownList>
        </div>

           <div class="row">
            <label style="color:white">Seleccione Estado</label>
             <asp:DropDownList ID="Estado" runat="server" CssClass="dis3" AutoPostBack="false"></asp:DropDownList>
        </div>
      ...
      <p>
        ...
        <script>
            $('#<%=Categoria.ClientID%>').chosen();
        </script>
        <script>
            $('#<%=Subcategoria.ClientID%>').chosen();
        </script>
    </form>
</body>
</html>
