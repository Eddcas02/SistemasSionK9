<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AyudaEstado.aspx.cs" Inherits="SistemaSionF1.Views.Sesion.Ayudas.AyudaEstado" %>
...
<body>
    ...
    <div class="topnav">
            ...
            <span class="nav-text" style="position: absolute;font-size: 25px;MARGIN: 0.6%;left: 37%;color: white; height: 20px;"><b style="margin-left: -117px;">Manual De Usuario Mantenimiento Estado</b></span>
...
<section class="tarjeta1">
        <p class="texto" style="text-align: justify">Al ingresar a la opcion de Area Administrativa Cumplimiento <i class="fa fa-sign-in" ></i>Etado, se podran vizualizar los diccionarios del mantenimiento Estado que se le mostraran al usuario. </p>
    <div class="frase">
      <div >
            <img class="foto1" src="../../../Imagenes/Imagenes/MantenimientoEstado.PNG">
      </div>
    </div>
</section>
...
<section class="tarjeta2">
    <div>
         <img class="foto2" src="../../../Imagenes/Imagenes/MantenimientoEstado1.PNG">
      <div class="frase">
      </div>
    </div>
...
<section class="tarjeta3">
    ...
    <div class="frase">
      <div >
           <img class="foto3" src="../../../Imagenes/Imagenes/MantenimientoEstado2.PNG">
      </div>
    </div>
</section>
