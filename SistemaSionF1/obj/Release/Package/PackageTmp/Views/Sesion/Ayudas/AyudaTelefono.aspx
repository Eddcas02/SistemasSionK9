<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AyudaTelefono.aspx.cs" Inherits="SistemaSionF1.Views.Sesion.Ayudas.AyudaTelefono" %>
...
<body>
    ...
    <div class="topnav">
            ...
            <span class="nav-text" style="position: absolute;font-size: 25px;MARGIN: 0.6%;left: 37%;color: white; height: 20px;"><b style="margin-left: -117px;">Manual De Usuario Mantenimiento Telefono</b></span>
...
<section class="tarjeta1">
        <p class="texto" style="text-align: justify">Al ingresar a la opcion de Area Administrativa Cumplimiento <i class="fa fa-sign-in" ></i>Telefono, se podran vizualizar los diccionarios del mantenimiento Telefono que se le mostraran al usuario. </p>
    <div class="frase">
      <div >
            <img class="foto1" src="../../../Imagenes/Imagenes/MantenimientoTelefono.PNG">
      </div>
    </div>
</section>
...
<section class="tarjeta2">
    <div>
         <img class="foto2" src="../../../Imagenes/Imagenes/MantenimientoTelefono1.PNG">
      <div class="frase">
      </div>
    </div>
...
<section class="tarjeta3">
    ...
    <div class="frase">
      <div >
           <img class="foto3" src="../../../Imagenes/Imagenes/MantenimientoTelefono2.PNG">
      </div>
    </div>
</section>
