<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AyudaPrestamos.aspx.cs" Inherits="SistemaSionF1.Views.Sesion.Ayudas.AyudaPrestamos" %>
...
<body>
    ...
    <div class="topnav">
            ...
            <span class="nav-text" style="position: absolute;font-size: 25px;MARGIN: 0.6%;left: 37%;color: white; height: 20px;"><b style="margin-left: -117px;">Manual De Usuario Mantenimiento Prestamo</b></span>
...
<section class="tarjeta1">
        <p class="texto" style="text-align: justify">Al ingresar a la opcion de Area Administrativa Cumplimiento <i class="fa fa-sign-in" ></i>Prestamo, se podran vizualizar los diccionarios del mantenimiento Prestamo que se le mostraran al usuario. </p>
    <div class="frase">
      <div >
            <img class="foto1" src="../../../Imagenes/Imagenes/MantenimientoPrestamos.PNG">
      </div>
    </div>
</section>
...
<section class="tarjeta2">
    <div>
         <img class="foto2" src="../../../Imagenes/Imagenes/MantenimientoPrestamos1.PNG">
      <div class="frase">
      </div>
    </div>
...
<section class="tarjeta3">
    ...
    <div class="frase">
      <div >
           <img class="foto3" src="../../../Imagenes/Imagenes/MantenimientoPrestamos2.PNG">
      </div>
    </div>
</section>
