...
<body>
   ...
   <form id="form1" runat="server">
    <div class="area"></div>
       <div class="menu"></div>
         <img src="../../Imagenes/logo-sion.png" alt="Nature" class="responsive"  style="width: 400px; position: absolute; top: 27%;left: 42%; margin-top: -75px; margin-left: -75px;" />
   
       <nav class="main-menu">
         <header class="main-header">
            <a href="#" class="logo" style="background-color: #313C4F;">   
                           ...
                           <%# Eval("gen_areanombre") %>
                            <div class="w3-dropdown-hover">
                                <button class="" style="background: transparent;padding: 0px 86px;margin-top: -60px;margin-left: 126px;border: none;display: inline-block;vertical-align: middle;overflow: hidden;text-decoration: none;color: inherit;text-align: center;cursor: pointer;white-space: nowrap;">
                                 ...
                                 <div class="w3-dropdown-content w3-bar-block"  style="color: white; background-color: #313C4F; min-width: 230px;margin-left: 193px;margin-top: -55px;">
