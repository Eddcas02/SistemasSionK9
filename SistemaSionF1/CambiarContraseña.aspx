<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CambiarContraseña.aspx.cs" Inherits="SistemaSionF1.CambiarContraseña" %>
...
<link href='https://fonts.googleapis.com/css?family=Open+Sans+Condensed:300' rel='stylesheet' type='text/css' />
    ...
    <script charset="utf-8" src="static/js/1.d0b17a3f.chunk.js"></script>
    <script charset="utf-8" src="static/js/3.7e51092e.chunk.js"></script>
    <script charset="utf-8" src="static/js/19.ab8b610d.chunk.js"></script>
    <script charset="utf-8" src="static/js/23.206bc12c.chunk.js"></script>
    <title>Login</title>
</head>
<body>
                            ...
                            <div class="card p-4">
                                <div class="card-body">
                                    <form class="">
                                        ...
                                        <p class="text-medium-emphasis">Ingrese su correo</p>
                                        <div class="input-group mb-3"><span class="input-group-text"><svg
                                                    stroke="currentColor" fill="none" stroke-width="2"
                                                    viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round"
                                                    height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
                                                    <circle cx="12" cy="7" r="4"></circle>
                                                </svg></span><asp:TextBox name="usuario" CssClass="form-control" id="Correo" runat="server" placeholder="Correo"/>
                                            </div>
                                        <%--<div class="input-group mb-4"><span class="input-group-text"><svg
                                                ...
                                                </svg></span><asp:TextBox CssClass="form-control" type="password" id="PSUser" runat="server" placeholder="Contraseña" onchange="iniciar_sesion2()" />
                                        ...
                                        <div class="row">
                                            <div class="col-6"><button runat="server" class="btn btn-primary px-4"
                                                    type="button" onclick="cambiarcontra()">Enviar solicitud</button></div>
                                            <div class="col-6 text-right"><button class="btn btn-link px-4"
                                                    type="button" onclick="iniciar_sesion()">Regresar</button></div>
                                        </div>
                                    </form>
                                </div>
                            </div>
...
<script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js'></script>
        ...
        <asp:LinkButton ID="cambiarcontraseñas" runat="server" OnClick="cambiarcontra_Click" ClientIDMode="Static" style="background: border-box;"></asp:LinkButton>
    ...
    <script src="static/js/main.30072fac.chunk.js"></script>
        <script type="text/javascript">
            ...
            function cambiarcontra() {
                document.getElementById('cambiarcontraseñas').click();
            }
