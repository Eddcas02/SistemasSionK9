                            ...
                            <div class="card p-4">
                                <div class="card-body">
                                    <form class="">
                                        ...
                                        <p class="text-medium-emphasis">Inicie sesión con su correo o usuario</p>
                                        <div class="input-group mb-3"><span class="input-group-text"><svg
                                                ...
                                                </svg></span><asp:TextBox name="usuario" CssClass="form-control" id="IdUser" runat="server"  placeholder="Usuario"/>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6"><button runat="server" class="btn btn-primary px-4"
                                                    type="submit" onclick="iniciar_sesion()">Iniciar Sesión</button></div>
