        ...
        <div class="general">
            ...
            <div class="formatoTitulo" style="margin-bottom:5px">
               ...
               <br /><br /><br />
                ...
                OnRowUpdating="gridColaboradores_RowUpdating">
                            <Columns>
                                ...
                                <asp:TemplateField ControlStyle-CssClass="diseño"  HeaderText="Id Colaborador">
                                 ...
                                 <asp:TemplateField ControlStyle-CssClass="diseño"  HeaderText="Nombre Colaborador">
                                    ...
                                    <ItemTemplate>
                                     ...
                                     <EditItemTemplate>
                                        <asp:TextBox ID="txtEntrada" Text='<%# Eval("Entrada","{0:t}") %>' runat="server" />
                                    </EditItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ControlStyle-CssClass="diseño"  HeaderText="Hora Salida">
                                    <ItemTemplate>
                                     ...
                                     <EditItemTemplate>
                                        <asp:TextBox ID="txtSalida" Text='<%# Eval("Salida","{0:t}") %>' runat="server" />
                                    </EditItemTemplate>
                                </asp:TemplateField>
