<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AyudaInmuebles.aspx.cs" Inherits="SistemaSionF1.Views.Sesion.Ayudas.AyudaInmuebles" %>
...
<body>
    ...
    <div class="topnav">
            ...
            <span class="nav-text" style="position: absolute;font-size: 25px;MARGIN: 0.6%;left: 37%;color: white; height: 20px;"><b style="margin-left: -117px;">Manual De Usuario Mantenimiento Inmuebles</b></span>
...
<section class="tarjeta1">
        <p class="texto" style="text-align: justify">Al ingresar a la opcion de Area Administrativa Cumplimiento <i class="fa fa-sign-in" ></i>Inmuebles, se podran vizualizar los diccionarios del mantenimiento Inmuebles que se le mostraran al usuario. </p>
       
    <div class="frase">
      <div >
            <img class="foto1" src="../../../Imagenes/Imagenes/MantenimientoInmuebles1.PNG">
      </div>
    </div>
</section>
...
<section class="tarjeta2">
    <div>
         <img class="foto2" src="../../../Imagenes/Imagenes/MantenimientoInmuebles2.PNG">
      <div class="frase">
      </div>
    </div>
...
<section class="tarjeta3">
    ...
    <div class="frase">
      <div >
           <img class="foto3" src="../../../Imagenes/Imagenes/MantenimientoInmuebles3.PNG">
      </div>
    </div>
</section>
