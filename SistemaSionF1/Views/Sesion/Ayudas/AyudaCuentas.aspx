<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AyudaCuentas.aspx.cs" Inherits="SistemaSionF1.Views.Sesion.Ayudas.AyudaCuentas" %>
...
<section class="tarjeta1">
        <p class="texto" style="text-align: justify">Al ingresar a la opcion de Area Administrativa Cumplimiento <i class="fa fa-sign-in" ></i> Cuentas, se podran vizualizar los diccionarios del mantenimiento cuentas que se le mostraran al usuario. </p>
       
    <div class="frase">
      <div >
            <img class="foto1" src="../../../Imagenes/Imagenes/MantenimientoCuentas1.PNG">
      </div>
    </div>
</section>
...
<section class="tarjeta2">
    <div>
         <img class="foto2" src="../../../Imagenes/Imagenes/MantenimientoCuentas2.PNG">
      <div class="frase">
      </div>
    </div>
...
<section class="tarjeta3">
    ...
    <div class="frase">
      <div >
           <img class="foto3" src="../../../Imagenes/Imagenes/MantenimientoCuentas3.PNG">
      </div>
    </div>
</section>
