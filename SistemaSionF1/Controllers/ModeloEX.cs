...
namespace SistemaSionF1.Controllers
{
    public class ModeloEX
    {
        ...
        public string buscarestadohall(string hall)
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    string sql = " SELECT  estadohall   FROM ex_hallazgos where codexhall = '" + hall + "'  ";
        ...
        public string contenv(string area)
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    string sql = "SELECT COUNT(exenv.codexenvio) FROM ex_envio exenv INNER JOIN ex_temporal1 ext ON ext.Nocredito = exenv.Nocredito  WHERE  ext.codexarea = '" + area + "' and (exenv.estado = 1 AND exenv.codexetapa =3) OR (exenv.estado = 2 AND exenv.codexetapa =3) OR (exenv.estado = 1 AND exenv.codexetapa =5) ;";
                    MySqlCommand command = new MySqlCommand(sql, sqlCon);
                    MySqlDataReader reader = command.ExecuteReader();
                    reader.Read();
                    camporesultante = reader.GetValue(0).ToString();
        ...
        public string contjur(string area)
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    string sql = "SELECT COUNT(exenv.codexenvio) FROM ex_envio exenv INNER JOIN ex_temporal1 ext ON ext.Nocredito = exenv.Nocredito WHERE  ext.codexarea = '" + area + "' and (exenv.estado = 1 AND exenv.codexetapa = 4) OR (exenv.estado = 8 AND exenv.codexetapa = 4) OR (exenv.estado = 2 AND exenv.codexetapa = 4)  ;";
                    MySqlCommand command = new MySqlCommand(sql, sqlCon);
                    MySqlDataReader reader = command.ExecuteReader();
                    reader.Read();
                    camporesultante = reader.GetValue(0).ToString();
        ...
        public string contpen(string area)
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    string sql = "SELECT COUNT(exenv.codexenvio)  FROM ex_envio exenv INNER JOIN ex_temporal1 ext ON ext.Nocredito = exenv.Nocredito  WHERE  ext.codexarea = '" + area + "' and (exenv.estado = 2  AND exenv.codexetapa =2) OR (exenv.estado = 6  AND exenv.codexetapa =5) ;";
                    MySqlCommand command = new MySqlCommand(sql, sqlCon);
                    MySqlDataReader reader = command.ExecuteReader();
                    reader.Read();
                    camporesultante = reader.GetValue(0).ToString();
        ...
        public string contreten(string area)
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    string sql = "SELECT COUNT( DISTINCT exh.codexp)  FROM  ex_hallazgos exh  INNER JOIN ex_expediente exp ON exp.codexp = exh.codexp INNER JOIN ex_temporal1 ext ON ext.Nocredito = exp.codgencred WHERE  ext.codexarea = '" + area + "' and  exh.estadohall = 1 ;";
                    MySqlCommand command = new MySqlCommand(sql, sqlCon);
                    MySqlDataReader reader = command.ExecuteReader();
                    reader.Read();
                    camporesultante = reader.GetValue(0).ToString();
        ...
        public string contret(string area)
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    string sql = "SELECT COUNT(exenv.codexenvio)  FROM ex_envio exenv INNER JOIN ex_temporal1 ext ON ext.Nocredito = exenv.Nocredito  WHERE  ext.codexarea = '" + area + "' AND (exenv.estado = 2  AND exenv.codexetapa = 1) OR (exenv.estado = 6  AND exenv.codexetapa = 5)  ;";
                    MySqlCommand command = new MySqlCommand(sql, sqlCon);
                    MySqlDataReader reader = command.ExecuteReader();
                    reader.Read();
                    camporesultante = reader.GetValue(0).ToString();
        ...
        public string contarch(string area)
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    string sql = "SELECT COUNT(exenv.codexenvio)  FROM ex_envio exenv INNER JOIN ex_temporal1 ext ON ext.Nocredito = exenv.Nocredito WHERE  ext.codexarea = '" + area + "' AND  exenv.estado = 1 AND exenv.codexetapa =7   ;";
                    MySqlCommand command = new MySqlCommand(sql, sqlCon);
                    MySqlDataReader reader = command.ExecuteReader();
                    reader.Read();
                    camporesultante = reader.GetValue(0).ToString();
        ...
        public string[] agencias()
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                try
                {
                    string consultaGraAsis = "SELECT codexcontrolarea FROM ex_controlarea  WHERE extipoarea = 1";
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand(consultaGraAsis, sqlCon);
                    MySqlDataReader reader = command.ExecuteReader();
                    while (reader.Read())
        ...
        public DataTable reportearchivopendientes()
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand("SELECT tmp.Nocredito, CONCAT_ws(' ', gep.gen_peticionesprimernombre, gep.gen_peticionessegundonombre, gep.gen_peticionestercernombre, gep.gen_peticionesprimerapellido, gep.gen_peticionessegundoapellido) AS nomcom, gep.gen_peticionescodigocliente AS cifgeneral , CONCAT('Q',FORMAT(gep.gen_peticionesmontocredito,2,'de_DE')) as gen_monto, gep.gen_peticionesfechacredito as gen_fechadesembolso, extp.ex_nomtipo AS ex_nomtipo, 1 as estatus FROM gen_peticiones gep INNER JOIN ex_tipocredito extp ON extp.codextipocred = gep.gen_peticionesgarantia INNER JOIN ex_temporal1 tmp ON tmp.Nocredito = gep.gen_peticionesnumerocredito INNER JOIN ex_envio exv ON exv.Nocredito = gep.gen_peticionesnumerocredito WHERE tmp.estado = 2 AND exv.estado = 2 AND exv.codexetapa = 5", sqlCon);
        ...
        public DataTable reportearchivo()
        {
            DataTable dt = new DataTable();
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand("SELECT tmp.Nocredito, CONCAT_ws(' ', gep.gen_peticionesprimernombre, gep.gen_peticionessegundonombre, gep.gen_peticionestercernombre, gep.gen_peticionesprimerapellido, gep.gen_peticionessegundoapellido) AS nomcom, gep.gen_peticionescodigocliente AS cifgeneral , CONCAT('Q',FORMAT(gep.gen_peticionesmontocredito,2,'de_DE')) as gen_monto, gep.gen_peticionesfechacredito as gen_fechadesembolso,gep.gen_peticionesfechacreacion as fecha_creacion  , extp.ex_nomtipo AS ex_nomtipo, exa.ex_nombrea , 1 as estatus FROM gen_peticiones gep INNER JOIN ex_tipocredito extp ON extp.codextipocred = gep.gen_peticionesgarantia INNER JOIN ex_temporal1 tmp ON tmp.Nocredito = gep.gen_peticionesnumerocredito INNER JOIN ex_envio exv ON exv.Nocredito= gep.gen_peticionesnumerocredito INNER JOIN ex_controlarea exa ON exv.codorigenarea= exa.codexcontrolarea  WHERE tmp.estado = 2", sqlCon);
                    MySqlDataAdapter ds = new MySqlDataAdapter();
                    ds.SelectCommand = command;
                    ds.Fill(dt);
        ...
        //public DataTable reportearchivofecha(string fechai, string fechaf)
        //{
        //    DataTable dt = new DataTable();
        //    using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
        //    {
        ...
        //        {
        //            sqlCon.Open();
        //            MySqlCommand command = new MySqlCommand("SELECT tmp.Nocredito, CONCAT_ws(' ', gep.gen_peticionesprimernombre, gep.gen_peticionessegundonombre, gep.gen_peticionestercernombre, gep.gen_peticionesprimerapellido, gep.gen_peticionessegundoapellido) AS nomcom, gep.gen_peticionescodigocliente AS cifgeneral , CONCAT('Q',FORMAT(gep.gen_peticionesmontocredito,2,'de_DE')) as gen_monto, gep.gen_peticionesfechacredito as gen_fechadesembolso, extp.ex_nomtipo AS ex_nomtipo, 1 as estatus FROM gen_peticiones gep INNER JOIN ex_tipocredito extp ON extp.codextipocred = gep.gen_peticionesgarantia INNER JOIN ex_temporal1 tmp ON tmp.Nocredito = gep.gen_peticionesnumerocredito WHERE tmp.estado = 2 AND gep.gen_peticionesfechacredito BETWEEN '" + fechai + "' AND '" + fechaf + "' ", sqlCon);
        //            MySqlDataAdapter ds = new MySqlDataAdapter();
        //            ds.SelectCommand = command;
        //            ds.Fill(dt);
        ...
        public DataTable codigosunidades(string area)
        {
            DataTable dt = new DataTable();
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
        ...
        public string cargados(string area)
        {
            String camporesultante = "";
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    string sql = "SELECT COUNT(tmp.Nocredito) FROM ex_temporal1 tmp  WHERE  tmp.estado = 7 AND tmp.codexarea =  '" + area + "'; ";
                    MySqlCommand command = new MySqlCommand(sql, sqlCon);
                    MySqlDataReader reader = command.ExecuteReader();
                    reader.Read();
                    camporesultante = reader.GetValue(0).ToString();
        ...
        public string mesa(string area)
        {
            String camporesultante = "";
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    string sql = "SELECT COUNT(exv.Nocredito) FROM ex_envio exv  INNER JOIN ex_controlarea exa on exa.codexcontrolarea = exv.codorigenarea WHERE   ((exv.estado= 2 and exv.codexetapa=5) OR (exv.estado= 1 and exv.codexetapa=5) OR  (exv.estado= 1 and exv.codexetapa=3) OR (exv.estado= 8 and exv.codexetapa=3) OR (exv.estado= 9 and exv.codexetapa=2) )AND   exv.codorigenarea= '" + area + "'";
                    MySqlCommand command = new MySqlCommand(sql, sqlCon);
                    MySqlDataReader reader = command.ExecuteReader();
                    reader.Read();
                    camporesultante = reader.GetValue(0).ToString();
        ...
        public string juridico(string area)
        {
            String camporesultante = "";
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    string sql = "SELECT COUNT(exv.Nocredito) FROM ex_envio exv  INNER JOIN ex_controlarea exa on exa.codexcontrolarea = exv.codorigenarea WHERE  ((exv.estado= 2 and exv.codexetapa=4)  OR (exv.estado= 8 and exv.codexetapa=4) OR (exv.estado= 1 and exv.codexetapa=4)) AND exv.codorigenarea= '" + area + "' ";
                    MySqlCommand command = new MySqlCommand(sql, sqlCon);
                    MySqlDataReader reader = command.ExecuteReader();
                    reader.Read();
                    camporesultante = reader.GetValue(0).ToString();
        ...
        public string archivo(string area)
        {
            String camporesultante = "";
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    string sql = "SELECT COUNT(exv.Nocredito) FROM ex_envio exv  INNER JOIN ex_controlarea exa on exa.codexcontrolarea = exv.codorigenarea WHERE  exv.estado= 1 and exv.codexetapa=7 AND exv.codorigenarea=  '" + area + "'; ";
                    MySqlCommand command = new MySqlCommand(sql, sqlCon);
                    MySqlDataReader reader = command.ExecuteReader();
                    reader.Read();
                    camporesultante = reader.GetValue(0).ToString();
        ...
        public string mensajeria(string area)
        {
            String camporesultante = "";
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    string sql = "SELECT COUNT(exv.Nocredito) FROM ex_envio exv INNER JOIN ex_controlarea exa on exa.codexcontrolarea = exv.codorigenarea WHERE ((exv.estado= 9 and exv.codexetapa=6) OR (exv.estado= 1 and exv.codexetapa=2) OR (exv.estado= 9 and exv.codexetapa=2) OR (exv.estado= 6 and exv.codexetapa=5)) AND exv.codorigenarea='" + area + "'    ";
                    MySqlCommand command = new MySqlCommand(sql, sqlCon);
                    MySqlDataReader reader = command.ExecuteReader();
                    reader.Read();
                    camporesultante = reader.GetValue(0).ToString();
        ...
        public string nombreagencia(string area)
        {
            String camporesultante = "";
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    string sql = "SELECT ex_nombrea FROM ex_controlarea  WHERE codexcontrolarea = '" + area + "' ; ";
                    MySqlCommand command = new MySqlCommand(sql, sqlCon);
                    MySqlDataReader reader = command.ExecuteReader();
                    reader.Read();
                    camporesultante = reader.GetValue(0).ToString();
        ...
        public DataTable llenarporareaage(string area)
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand(" SELECT DISTINCT gep.gen_peticionescodigocliente AS cifgeneral, gep.gen_peticionesnumerocredito AS gen_numcredito, CONCAT_ws(' ', gep.gen_peticionesprimernombre, gep.gen_peticionessegundonombre, gep.gen_peticionestercernombre, gep.gen_peticionesprimerapellido, gep.gen_peticionessegundoapellido) AS nombrecompleto , CONCAT('Q',FORMAT(gep.gen_peticionesmontocredito,2,'de_DE')) as gen_monto, extp.ex_nomtipo AS ex_nomtipo FROM gen_peticiones gep INNER JOIN ex_tipocredito extp ON extp.codextipocred = gep.gen_peticionesgarantia INNER JOIN ex_temporal1 tmp ON tmp.Nocredito = gep.gen_peticionesnumerocredito INNER JOIN ex_expediente exp ON exp.codgencred = gep.gen_peticionesnumerocredito INNER JOIN ex_envio exenv ON exenv.Nocredito=exp.codgencred INNER JOIN ex_hallazgos h on h.codexp =exp.codexp WHERE tmp.codexarea ='" + area + "'  and h.estadohall = 1  ", sqlCon);
                    MySqlDataAdapter ds = new MySqlDataAdapter();
                    ds.SelectCommand = command;
                    ds.Fill(dt);
        ...
        public string fechaconfig()
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    string sql = "SELECT DATE_FORMAT (fechaactual,  '%Y-%m-%d' ) FROM ex_fecha WHERE  estado =  1 ;";
                    MySqlCommand command = new MySqlCommand(sql, sqlCon);
                    MySqlDataReader reader = command.ExecuteReader();
                    reader.Read();
                    camporesultante = reader.GetValue(0).ToString();
        ...
        public DataTable llenarGridViewevento3(string user, string fecha)
        {
            DataTable dt = new DataTable();
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
        ...
        public DataTable llenarexphall(string area)
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand("SELECT DISTINCT gep.gen_peticionesfechacredito as gen_fechadesembolso, gep.gen_peticionescodigocliente AS cifgeneral ,gep.gen_peticionesnumerocredito AS gen_numcredito , CONCAT_ws(' ', gep.gen_peticionesprimernombre, gep.gen_peticionessegundonombre, gep.gen_peticionestercernombre, gep.gen_peticionesprimerapellido, gep.gen_peticionessegundoapellido) AS nombrecompleto, CONCAT('Q',FORMAT(gep.gen_peticionesmontocredito,2,'de_DE')) as gen_monto, extp.ex_nomtipo AS ex_nomtipo, gep.gen_peticionesusuariodelcredito as Usuario FROM gen_peticiones gep INNER JOIN ex_tipocredito extp ON extp.codextipocred = gep.gen_peticionesgarantia INNER JOIN ex_temporal1 tmp ON tmp.Nocredito = gep.gen_peticionesnumerocredito INNER JOIN ex_expediente exp ON exp.codgencred = gep.gen_peticionesnumerocredito INNER JOIN ex_hallazgos exh ON exh.codexp = exp.codexp WHERE tmp.codexarea = '" + area + "' AND exh.estadohall = 1 ORDER BY `gen_fechadesembolso` DESC; ", sqlCon);
                    MySqlDataAdapter ds = new MySqlDataAdapter();
                    ds.SelectCommand = command;
                    ds.Fill(dt);
        ...
        public DataTable llenarexphall2(string area)
        {
            DataTable dt = new DataTable();
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand("SELECT DISTINCT gep.gen_peticionesfechacredito as gen_fechadesembolso, gep.gen_peticionescodigocliente AS cifgeneral ,gep.gen_peticionesnumerocredito AS gen_numcredito , CONCAT_ws(' ', gep.gen_peticionesprimernombre, gep.gen_peticionessegundonombre, gep.gen_peticionestercernombre, gep.gen_peticionesprimerapellido, gep.gen_peticionessegundoapellido) AS nombrecompleto, CONCAT('Q',FORMAT(gep.gen_peticionesmontocredito,2,'de_DE')) as gen_monto, extp.ex_nomtipo AS ex_nomtipo, gep.gen_peticionesusuariodelcredito as Usuario , exh.hallazgo FROM gen_peticiones gep INNER JOIN ex_tipocredito extp ON extp.codextipocred = gep.gen_peticionesgarantia INNER JOIN ex_temporal1 tmp ON tmp.Nocredito = gep.gen_peticionesnumerocredito INNER JOIN ex_expediente exp ON exp.codgencred = gep.gen_peticionesnumerocredito INNER JOIN ex_hallazgos exh ON exh.codexp = exp.codexp WHERE tmp.codexarea = '" + area + "' AND exh.estadohall = 1 ORDER BY `gen_fechadesembolso` DESC; ", sqlCon);
                    MySqlDataAdapter ds = new MySqlDataAdapter();
                    ds.SelectCommand = command;
                    ds.Fill(dt);
        ...
        public DataTable llenarexphall3()
        {
            DataTable dt = new DataTable();
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand("SELECT DISTINCT gep.gen_peticionesfechacredito as gen_fechadesembolso, gep.gen_peticionescodigocliente AS cifgeneral ,gep.gen_peticionesnumerocredito AS gen_numcredito , i.ex_nombrea, CONCAT_ws(' ', gep.gen_peticionesprimernombre, gep.gen_peticionessegundonombre, gep.gen_peticionestercernombre, gep.gen_peticionesprimerapellido, gep.gen_peticionessegundoapellido) AS nombrecompleto, CONCAT('Q',FORMAT(gep.gen_peticionesmontocredito,2,'de_DE')) as gen_monto, extp.ex_nomtipo AS ex_nomtipo, gep.gen_peticionesusuariodelcredito as Usuario , exh.hallazgo FROM gen_peticiones gep INNER JOIN ex_tipocredito extp ON extp.codextipocred = gep.gen_peticionesgarantia INNER JOIN ex_temporal1 tmp ON tmp.Nocredito = gep.gen_peticionesnumerocredito INNER JOIN ex_expediente exp ON exp.codgencred = gep.gen_peticionesnumerocredito INNER JOIN ex_hallazgos exh ON exh.codexp = exp.codexp INNER JOIN ex_controlarea i on i.codexcontrolarea = tmp.codexarea WHERE  exh.estadohall = 1 ORDER BY `gen_fechadesembolso` DESC; ", sqlCon);
                    MySqlDataAdapter ds = new MySqlDataAdapter();
                    ds.SelectCommand = command;
                    ds.Fill(dt);
        ...
        public string obtenerpermiso(string usuario)
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    string sql = " SELECT exc.permisos FROM ex_controlingreso exc WHERE exc.ex_controlusuario = '" + usuario + "' ;";
                    MySqlCommand command = new MySqlCommand(sql, sqlCon);
                    MySqlDataReader reader = command.ExecuteReader();
                    reader.Read();
                    camporesultante = reader.GetValue(0).ToString();
        ...
        public DataTable llenar99(string user, string fecha)
        {
            DataTable dt = new DataTable();
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
        ...
        //public DataTable codigostable(string area)
        //{
        //    DataTable dt = new DataTable();
        //    using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
        //    {
        ...
        public DataTable codigostable(string area)
        {
            ...
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand("SELECT tmp.Nocredito,  CONCAT_ws(' ', gep.gen_peticionesprimernombre, gep.gen_peticionessegundonombre, gep.gen_peticionestercernombre, gep.gen_peticionesprimerapellido, gep.gen_peticionessegundoapellido) AS nomcom, gep.gen_peticionescodigocliente AS cifgeneral , CONCAT('Q',FORMAT(gep.gen_peticionesmontocredito,2,'de_DE')) as gen_monto, gep.gen_peticionesfechacredito as gen_fechadesembolso,  extp.ex_nomtipo AS ex_nomtipo  FROM gen_peticiones gep INNER JOIN ex_tipocredito extp ON extp.codextipocred = gep.gen_peticionesgarantia INNER JOIN ex_temporal1 tmp ON tmp.Nocredito = gep.gen_peticionesnumerocredito WHERE  tmp.estado = 10 AND tmp.codexarea = '" + area + "'; ", sqlCon);
                    MySqlDataAdapter ds = new MySqlDataAdapter();
                    ds.SelectCommand = command;
                    ds.Fill(dt);
        ...
        public DataTable codigostable2(string area)
        {
            DataTable dt = new DataTable();
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
        ...
        public DataTable obtenerlotespen(string area)
        {
            DataTable dt = new DataTable();
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand("SELECT DISTINCT exlo.numerolote FROM  ex_loteenvio exlo INNER JOIN ex_envio exn ON exn.codexenvio = exlo.codexenvio INNER JOIN ex_temporal1 ext ON ext.Nocredito = exn.Nocredito  WHERE exlo.area = '" + area + "' AND exlo.estado = '0' AND ext.estado = '10'", sqlCon);
                    MySqlDataAdapter ds = new MySqlDataAdapter();
                    ds.SelectCommand = command;
                    ds.Fill(dt);
        ...
        public string contarlote(string lote)
        {
            String camporesultante = "";
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    string sql = " SELECT COUNT(exl.codexenvio) FROM ex_loteenvio exl INNER JOIN ex_envio exn ON exl.codexenvio = exn.codexenvio  WHERE exl.numerolote = '" + lote + "' ";
                    MySqlCommand command = new MySqlCommand(sql, sqlCon);
                    MySqlDataReader reader = command.ExecuteReader();
                    reader.Read();
                    camporesultante = reader.GetValue(0).ToString();
        ...
        public DataTable creditosno(string fecha, string fecha2)
        {
            DataTable dt = new DataTable();
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand("SELECT DISTINCT gen_peticionesnumerocredito as cred, DATE_FORMAT(a.gen_peticionesfechacredito , '%Y-' '%m-' '%d') as fecha  FROM gen_peticiones a WHERE NOT EXISTS ( SELECT null FROM ex_temporal1 h WHERE a.gen_peticionesnumerocredito = h.Nocredito) AND a.gen_peticionesfechacredito BETWEEN '" + fecha + "' and '" + fecha2 + "' ", sqlCon);
                    MySqlDataAdapter ds = new MySqlDataAdapter();
                    ds.SelectCommand = command;
                    ds.Fill(dt);
        ...
        public DataTable ll(string f1, string f2)
        {
            DataTable dt = new DataTable();
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand("SELECT gep.gen_peticionesfechacredito as gen_fechadesembolso, gep.gen_peticionescodigocliente AS cifgeneral, gep.gen_peticionesnumerocredito AS gen_numcredito, CONCAT_ws(' ', gep.gen_peticionesprimernombre, gep.gen_peticionessegundonombre, gep.gen_peticionestercernombre, gep.gen_peticionesprimerapellido, gep.gen_peticionessegundoapellido) AS nombrecompleto, CONCAT('Q', FORMAT(gep.gen_peticionesmontocredito, 2, 'de_DE')) as gen_monto, extp.ex_nomtipo AS ex_nomtipo, c.etapa_actual, f.ex_evento, ar.ex_nombrea FROM gen_peticiones gep INNER JOIN ex_tipocredito extp ON extp.codextipocred = gep.gen_peticionesgarantia INNER JOIN ex_envio a ON a.Nocredito = gep.gen_peticionesnumerocredito INNER JOIN ex_expediente b on a.Nocredito = b.codgencred INNER JOIN ex_etapa c ON c.codexetapa = a.codexetapa INNER JOIN ex_tipoevento f ON f.codexevento = a.estado INNER JOIN ex_controlarea ar on ar.codexcontrolarea = a.codareauser WHERE((a.estado = 2 and a.codexetapa = 5) OR(a.estado = 1 and a.codexetapa = 7))AND gep.gen_peticionesfechacredito BETWEEN '" + f1 + "' AND '" + f2 + "' ORDER BY `gen_fechadesembolso` DESC", sqlCon);
                    MySqlDataAdapter ds = new MySqlDataAdapter();
                    ds.SelectCommand = command;
                    ds.Fill(dt);
        ...
        public DataTable estatusall(string fecha1, string fecha2)
        {
            DataTable dt = new DataTable();
            using (MySqlConnection sqlCon = new MySqlConnection(conexiongeneral.cadenadeconexiongeneral()))
            {
                ...
                {
                    sqlCon.Open();
                    MySqlCommand command = new MySqlCommand("SELECT gep.gen_peticionesfechacredito as gen_fechadesembolso, gep.gen_peticionescodigocliente AS cifgeneral ,gep.gen_peticionesnumerocredito AS gen_numcredito , CONCAT_ws(' ', gep.gen_peticionesprimernombre, gep.gen_peticionessegundonombre, gep.gen_peticionestercernombre, gep.gen_peticionesprimerapellido, gep.gen_peticionessegundoapellido) AS nombrecompleto, CONCAT('Q',FORMAT(gep.gen_peticionesmontocredito,2,'de_DE')) as gen_monto, extp.ex_nomtipo AS ex_nomtipo, c.etapa_actual, f.ex_evento, ar.ex_nombrea, h.numerolote as numerolote FROM gen_peticiones gep INNER JOIN ex_tipocredito extp ON extp.codextipocred = gep.gen_peticionesgarantia INNER JOIN ex_envio a ON a.Nocredito = gep.gen_peticionesnumerocredito INNER JOIN ex_expediente b on a.Nocredito = b.codgencred INNER JOIN ex_etapa c ON c.codexetapa= a.codexetapa INNER JOIN ex_tipoevento f ON f.codexevento = a.estado INNER JOIN ex_controlarea ar on ar.codexcontrolarea = a.codareauser INNER JOIN ex_loteenvio h on h.codexenvio= a.codexenvio WHERE  gep.gen_peticionesfechacredito BETWEEN '" + fecha1 + "' AND '" + fecha2 + "'  ORDER BY `gen_fechadesembolso` DESC", sqlCon);
                    MySqlDataAdapter ds = new MySqlDataAdapter();
                    ds.SelectCommand = command;
                    ds.Fill(dt);
